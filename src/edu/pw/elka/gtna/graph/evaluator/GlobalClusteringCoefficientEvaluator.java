...
public class GlobalClusteringCoefficientEvaluator<N extends Node,E extends Edge<N>> extends AbstractGraphEvaluator<N,E> {

	public GlobalClusteringCoefficientEvaluator(Graph<N, E> graph) {
		super(graph);
	}
